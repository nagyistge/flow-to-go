...
export interface Nodes {
  createNode: (node: Node, config: NodeDefinition) => void;
  registerType: (bundle: string, id: string, factory: (config: NodeDefinition) => void) => void;
  getFlows: () => null | {};
...
export interface Node {
  on: (event: 'input' | 'close', handler: InputHandler | CloseHandler) => void;
  send: (msg: Message) => void;
  emit: (event: 'input', msg: Message) => void;
  status: (status: {} | {
...
export type InputHandler = (msg: Message) => void
export type CloseHandler = (removed: boolean, done: () => void) => void
